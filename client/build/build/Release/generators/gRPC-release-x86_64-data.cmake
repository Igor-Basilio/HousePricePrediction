...
########### VARIABLES #######################################################################
#############################################################################################
set(grpc_PACKAGE_FOLDER_RELEASE "/home/Igor/.conan2/p/b/grpc4476e4ecef39b/p")
...
set(grpc_COMPONENTS_RELEASE gRPC::address_sorting gRPC::gpr gRPC::upb_base_lib gRPC::upb_mem_lib gRPC::utf8_range_lib gRPC::grpc_plugin_support grpc::grpc_execs gRPC::upb_mini_descriptor_lib gRPC::upb_message_lib gRPC::upb_wire_lib gRPC::grpc_unsecure gRPC::upb_json_lib gRPC::upb_textformat_lib gRPC::grpc_authorization_provider gRPC::grpc gRPC::grpc++_unsecure gRPC::grpc++ gRPC::grpc++_alts gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpcpp_channelz)
...
set(grpc_gRPC_grpcpp_channelz_DEPENDENCIES_RELEASE gRPC::grpc++ libsystemd::libsystemd)
...
set(grpc_gRPC_grpc++_reflection_DEPENDENCIES_RELEASE gRPC::grpc++ libsystemd::libsystemd)
...
set(grpc_gRPC_grpc++_error_details_DEPENDENCIES_RELEASE gRPC::grpc++ libsystemd::libsystemd)
...
set(grpc_gRPC_grpc++_alts_DEPENDENCIES_RELEASE gRPC::grpc++ libsystemd::libsystemd)
...
set(grpc_gRPC_grpc++_DEPENDENCIES_RELEASE absl::absl_check absl::absl_log gRPC::grpc protobuf::libprotobuf libsystemd::libsystemd)
...
set(grpc_gRPC_grpc++_unsecure_DEPENDENCIES_RELEASE absl::absl_check absl::absl_log gRPC::grpc_unsecure protobuf::libprotobuf libsystemd::libsystemd)
...
set(grpc_gRPC_grpc_DEPENDENCIES_RELEASE gRPC::upb_json_lib gRPC::upb_textformat_lib re2::re2 ZLIB::ZLIB absl::algorithm_container absl::config absl::no_destructor absl::cleanup absl::flat_hash_map absl::flat_hash_set absl::inlined_vector absl::bind_front absl::function_ref absl::hash absl::type_traits absl::random_bit_gen_ref absl::random_distributions absl::statusor absl::span absl::utility c-ares::cares gRPC::gpr OpenSSL::SSL OpenSSL::Crypto gRPC::address_sorting libsystemd::libsystemd)
...
set(grpc_gRPC_upb_textformat_lib_DEPENDENCIES_RELEASE gRPC::upb_mini_descriptor_lib gRPC::upb_wire_lib libsystemd::libsystemd)
...
set(grpc_gRPC_upb_json_lib_DEPENDENCIES_RELEASE gRPC::upb_mini_descriptor_lib gRPC::upb_wire_lib libsystemd::libsystemd)
...
set(grpc_gRPC_grpc_unsecure_DEPENDENCIES_RELEASE gRPC::upb_mini_descriptor_lib gRPC::upb_wire_lib ZLIB::ZLIB absl::algorithm_container absl::config absl::no_destructor absl::cleanup absl::flat_hash_map absl::flat_hash_set absl::inlined_vector absl::bind_front absl::function_ref absl::hash absl::type_traits absl::random_bit_gen_ref absl::random_distributions absl::statusor absl::span absl::utility c-ares::cares gRPC::gpr gRPC::address_sorting libsystemd::libsystemd)
...
set(grpc_gRPC_upb_wire_lib_DEPENDENCIES_RELEASE gRPC::utf8_range_lib gRPC::upb_message_lib libsystemd::libsystemd)
...
set(grpc_gRPC_upb_message_lib_DEPENDENCIES_RELEASE gRPC::upb_base_lib gRPC::upb_mem_lib libsystemd::libsystemd)
...
set(grpc_gRPC_upb_mini_descriptor_lib_DEPENDENCIES_RELEASE gRPC::upb_base_lib gRPC::upb_mem_lib libsystemd::libsystemd)
...
set(grpc_gRPC_grpc_plugin_support_DEPENDENCIES_RELEASE absl::status protobuf::libprotobuf protobuf::libprotoc libsystemd::libsystemd)
...
set(grpc_gRPC_utf8_range_lib_DEPENDENCIES_RELEASE libsystemd::libsystemd)
...
set(grpc_gRPC_upb_mem_lib_DEPENDENCIES_RELEASE libsystemd::libsystemd)
...
set(grpc_gRPC_upb_base_lib_DEPENDENCIES_RELEASE libsystemd::libsystemd)
...
set(grpc_gRPC_address_sorting_DEPENDENCIES_RELEASE libsystemd::libsystemd)
